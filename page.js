const products = [
    ...
    },
    {
        name: 'Shirt',
        image: './shirt.png',
        description: 'These t-shirts are a comfortable and durable alternative to standard cotton tees. It is designed to be worn all day by the man in demand. This classic design will keep you on the go with a gentle fabric for comfort all day.',        price: 1000,
    },
];
...
function addCart(itemName, itemPrice) {
    ...
    if (newItem) {
        newProd++
        newItem.quantity++;
        document.querySelector('#cartItemCountBadge').innerHTML = newProd;
    } else {
